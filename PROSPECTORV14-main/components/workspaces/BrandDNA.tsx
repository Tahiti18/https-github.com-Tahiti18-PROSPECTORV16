...
export const BrandDNA: React.FC<BrandDNAProps> = ({ lead, onUpdateLead, onNavigate }) => {
  ...
  const handleExtract = async () => {
    ...
    // Simulation for cinematic effect (~20s total)
            ...
            <div className="relative w-full max-w-xl bg-[#141414] rounded-[48px] p-16 text-center shadow-2xl border border-slate-800/80 overflow-hidden">
                ...
                <div className="space-y-10 relative z-10">
                    ...
                    <div className="inline-flex items-center gap-3 px-6 py-3 bg-[#c2d18b] border border-[#c2d18b]/30 rounded-full">
                       ...
                       <span className="text-[12px] font-black text-black uppercase tracking-wide animate-in fade-in" key={scanStep}>{SCAN_STEPS[scanStep]}</span>
                    </div>
                    ...
                    <div className="pt-4 flex flex-col items-center gap-4">
                       <div className="flex items-center gap-2">
                          ...
                          <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest italic animate-pulse">ABOUT 5 MINUTES LEFT</p>
                       </div>
                       {/* Progress Bar */}
      ...
      return (
          <div className="max-w-[1550px] mx-auto py-12 px-8 space-y-12 animate-in fade-in zoom-in-95 duration-1000 bg-[#0a0a0a] min-h-screen pb-40">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                  {/* Left Column: Brand Cards (The Cartier Style) */}
                  <div className="lg:col-span-6 space-y-6 flex flex-col">
                      <div className="bg-[#141414] rounded-[32px] p-12 flex flex-col justify-between border-2 border-slate-800/50 shadow-xl relative overflow-hidden flex-1 min-h-[450px]">
                          <div className="space-y-4">
                              <h2 className="text-4xl font-serif text-white uppercase tracking-tighter leading-none">{activeEntity.businessName}</h2>
                          ...
                          <div className="grid grid-cols-2 gap-6 mt-12">
                              <div className="bg-[#1a1a1a] p-12 rounded-[40px] border border-slate-800 flex flex-col justify-center items-center text-center group transition-all hover:bg-slate-900 shadow-xl">
                                  ...
                                  <span className="text-7xl font-serif leading-none text-[#c2d18b]">Aa</span>
                                  ...
                                  <div className="flex gap-6">
                                      {(activeIdentity.colors || []).slice(0,3).map((c, i) => (
                                          <div key={i} className="flex flex-col items-center gap-4">
                                              <div className="w-14 h-14 rounded-full border-4 border-[#141414] shadow-2xl transition-transform group-hover:scale-110" style={{ backgroundColor: c }}></div>
                      ...
                      <div className="bg-[#141414] rounded-[48px] p-12 border-2 border-slate-800/50 shadow-xl space-y-10">
                          ...
                          {activeIdentity.manifesto && (
                            <div className="pt-8 border-t border-slate-800">
                                ...
                                <p className="text-[14px] text-slate-300 font-medium leading-relaxed italic line-clamp-10">"{activeIdentity.manifesto}"</p>
                            </div>
                          )}
                      </div>
                  </div>

                  {/* Right Column: Assets Grid (matching Cartier screenshot) */}
                  <div className="lg:col-span-6 bg-[#141414] border-2 border-slate-800/50 rounded-[56px] p-12 shadow-2xl flex flex-col min-h-[900px]">
                      <div className="flex justify-between items-center mb-12 border-b border-slate-800/50 pb-10">
                          <div className="space-y-1">
                            ...
                            <p className="text-[10px] text-slate-600 font-bold uppercase tracking-widest italic">Extracted via Premier Alchemy engine.</p>
                          </div>
                          <div className="flex items-center gap-8">
                             <button 
                                onClick={() => manualUploadRef.current?.click()}
                                className="px-6 py-3 bg-[#1a1a1a] border border-slate-800 rounded-2xl text-[10px] font-black text-slate-400 hover:bg-emerald-500 hover:text-black hover:border-emerald-500 transition-all shadow-lg"
                             >
                                + UPLOAD MANUALLY
                             </button>
